...
public class BarCodeScanActivityproductreduce extends AppCompatActivity {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() > 0 && !isBarcodeDetected) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Intent intent = new Intent(BarCodeScanActivityproductreduce.this, ProductReduce.class);
