...
public class SubDepartmentAutoCompleteAdapter extends ArrayAdapter<SubDepartmentspinner> {
    private List<SubDepartmentspinner> subDepartmentListFull;
    private List<SubDepartmentspinner> subDepartmentListFiltered;
    private LayoutInflater inflater;

    public SubDepartmentAutoCompleteAdapter(Context context, List<SubDepartmentspinner> subDepartments) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_subdepartment_item, parent, false);
        }
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            // Inflate the custom layout for dropdown items
            convertView = inflater.inflate(R.layout.custom_subdepartment_item, parent, false);
        }
